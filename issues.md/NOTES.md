...
You are a staff level full stack engineer. Your task is to **re-evaluate and refactor the CTX repository** according to the coding standards already written in **AGENTS.md**.  
